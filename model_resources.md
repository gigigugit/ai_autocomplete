...
This document summarises candidate base models for LoRA / QLoRA fine-tuning
...
| Gemma 2 2B | 2.6 B | `google/gemma-2-2b` | Efficient architecture, good text continuation. | Well-supported in HF ecosystem. |
